...
func TestToolSchemaContainsOnlyCoordinationSurface(t *testing.T) {
	required := map[string]bool{"read_state": true, "create_project": true, "update_brief": true, "set_team": true, "queue_task": true, "resolve_decision": true, "stop_task": true, "ask_decision": true, "remember_preference": true, "report_status": true, "list_connections": true, "query_connection": true, "set_landing": true, "land_task": true, "wake_me_when": true, "list_wakes": true, "cancel_wake": true, "order_tasks": true, "message_team": true}
