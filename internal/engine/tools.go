...
type SetTeamArgs struct {
	...
	PlannerMember     string `json:"planner_member"`
...
var tools = []labelled{
	...
	{Tool: tool("read_state", "Read current projects with their briefs and teams, tasks with their revisions and reviews, decisions, preferences and recent activity.", nil, nil), label: "Check project context"},
