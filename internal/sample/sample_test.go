...
func TestTheSampleShowsWorkAtEveryStageAndNeverTouchesRealState(t *testing.T) {
	...
	for _, want := range []string{core.StageTodo, core.StageResearching, core.StageDesigning, core.StageImplementing, core.StageReviewing, core.StageQA, core.StageReady, core.StageDone} {
		if !stages[want] {
